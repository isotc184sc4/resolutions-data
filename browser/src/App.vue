    ...
    <div class="site-header__inner">
      ...
      <div class="site-header__actions">
        ...
        <div class="site-header__external-links">
          ...
          <a :href="committee.links.committeeSite" target="_blank" rel="noopener noreferrer" class="site-header__icon-btn" aria-label="ISO Committee">
      ...
      <div class="site-footer__grid">
        ...
        <div>
          ...
          <ul class="site-footer__links">
            ...
            <li><a :href="committee.links.linkedin" class="site-footer__link" target="_blank" rel="noopener noreferrer">LinkedIn</a></li>
