    ...
    <div class="hero-section">
      ...
      <div class="hero-content">
        ...
        <p class="hero-subtitle animate-up" style="--nth: 2">
          ...
          <template v-else>
            {{ formatNumber(animResolutions) }} plenary resolutions from {{ formatNumber(animMeetings) }} meetings, spanning {{ yearRange.earliest }} to {{ yearRange.latest }}. {{ committee.tagline }}.
          </template>
        </p>
