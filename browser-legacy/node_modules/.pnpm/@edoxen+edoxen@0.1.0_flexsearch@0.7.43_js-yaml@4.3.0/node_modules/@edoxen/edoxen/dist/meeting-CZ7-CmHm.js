const e = "http://json-schema.org/draft-07/schema#", t = "https://github.com/edoxen/edoxen/schema/meeting.yaml", i = "Edoxen Meeting Schema", n = `Schema for validating Edoxen Meeting/Agenda YAML files.
...
`,
  ...
  Minutes: {
    type: "object",
    description: `The narrative record of a Meeting — what was said, by whom, in
...
`,
  ...
  Agenda: {
    type: "object",
    description: "The business-order document of a Meeting. Versioned independently\nof the Meeting via the `status` field (draft, final, amended).\n",
    additionalProperties: !1,
    properties: {
      identifier: {
        type: "array",
